...
const BannerText = ({ title }: Props) => {
  return (
    <div className=" hidden lg:inline-block absolute top-0 left-0 w-full h-full">
      <Container className="flex h-full flex-col gab-y6 justify-center">
        <motion.h2
        ...
        >
          <button className=" py-3 px-6 duration-200 rounded-full bg-slate-200 hover:bg-white text-sm uppercase font-semibold">
            Find our more
          </button>
          <button className=" py-3 px-6 duration-200 rounded-full bg-slate-200 hover:bg-white text-sm uppercase font-semibold">
            Shop Now
